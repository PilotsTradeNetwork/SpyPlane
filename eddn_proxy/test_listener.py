...
def main():
    """Main entry point"""
    parser = argparse.ArgumentParser(description="Test listener for EDDN proxy. Dumps all received events to a file.")
    parser.add_argument("filename", help="Output filename to dump events to (will be created/opened in append mode)")
