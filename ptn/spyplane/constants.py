...
CHANNEL_MONITORING = (
    PROD_CHANNEL_MONITORING if flag_production else TEST_CHANNEL_MONITORING
)
...
CONTROL_CHANNEL = (
    int(os.getenv("PROD_SPY_PLANE_CHANNEL_ID"))
    if flag_production
    else int(os.getenv("TEST_SPY_PLANE_CHANNEL_ID"))
)
REPORT_CHANNEL = (
    int(os.getenv("PROD_SPY_PLANE_REPORT_CHANNEL_ID"))
    if flag_production
    else int(os.getenv("TEST_SPY_PLANE_REPORT_CHANNEL_ID"))
)
